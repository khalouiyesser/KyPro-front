...
// ── Users (profil connecté + gestion admin) ───────────────────────────────────
export const usersApi = {
  // CRUD générique
  ...createCrudApi('users'),

  // Surcharge explicite pour clarté
